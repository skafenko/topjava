...
/**
 * Created by Mykhailo on 28.01.2017.
 */
public class MealRestControllerTest extends AbstractControllerTest {
    ...
    public void testGetAll() throws Exception {
        mockMvc.perform(get(REST_URL))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(MATCHER_WITH_EXCEED.contentListMatcher(MealsUtil.getWithExceeded(service.getAll(USER_ID), USER.getCaloriesPerDay())));
    }
    ...
    public void testCreate() throws Exception {
        ...
        MATCHER.assertEquals(created, service.get(returned.getId(), USER_ID));
    }
