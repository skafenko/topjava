...
public class MealsUtil {
    public static User user = new User(1, "Misha", "@mail.ru", "pass", Role.ROLE_USER);
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal(user, LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак", 1000),
            new Meal(user, LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед", 500),
            new Meal(user, LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин", 510)
    );
